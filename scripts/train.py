...
from models.sfcnet import SFCNet
...
def main(config: DictConfig):
    ...
    model = SFCNet(
        ...
        img_sem_loss = config.img_sem_loss,
    ...
    timepoint = '2023-08-15_18-56-5'
    model_path = os.path.join(logdir, 'exp' + timepoint + exp_name[22:], 'checkpoints/last.ckpt')
